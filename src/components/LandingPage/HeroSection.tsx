...
export const HeroSection = () => {
  ...
  return (
    <section className="relative bg-slate-50 pt-16 pb-20 lg:pt-10 lg:pb-32 overflow-hidden mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            >
              <Badge
                variant="outline"
                className="mb-6 px-4 py-1.5 border-blue-200 bg-blue-50 text-blue-800 rounded-full text-xs font-bold tracking-wide uppercase gap-2"
              >
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Project INTEGRITY harnesses <strong>AI Agents</strong> and{" "}
                <strong>Geospatial Tech</strong> to empower citizens. Verify
