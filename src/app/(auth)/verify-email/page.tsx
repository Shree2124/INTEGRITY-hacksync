  ...
  useEffect(() => {
    ...
    const checkInterval = setInterval(async () => {
      try {
        ...
        console.error("Error auto-checking verification:", err);
      }
    }, 3000);
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative flex-col justify-between p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-slate-400 text-lg leading-relaxed">
            Email verification helps us ensure the security and authenticity of
            all citizen auditors on the platform.
          </p>
        </div>
      </div>
