      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative flex-col justify-between p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-8">
            Create your immutable citizen identity. Contribute to the national
            infrastructure audit ledger and help build a corruption-free India.
          </p>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="agreed" className="font-medium text-slate-700">
                  Citizen Pledge
                </label>
