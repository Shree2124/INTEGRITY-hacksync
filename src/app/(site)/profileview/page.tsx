...
export default function ProfilePage() {
  ...
  const user = {
    ...
    email: "himanshu.k@integrity.gov.in",
    avatarUrl: "", 
      ...
      <div className="container mx-auto max-w-5xl py-12 px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 space-y-6 w-full">
            ...
            {/* Logout */}
            <button className="w-full py-4 rounded-xl border-2 border-red-100 bg-red-50 text-red-600 font-bold hover:bg-red-100 hover:border-red-200 transition-all flex items-center justify-center gap-2">
               <LogOut size={20} />
               Sign Out Securely
            </button>
