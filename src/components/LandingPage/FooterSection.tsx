        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/auditview" className="hover:text-orange-400 hover:translate-x-1 inline-flex items-center gap-2 transition-all duration-300">
                  <span className="w-1 h-1 rounded-full bg-slate-600"></span>
                  File an Audit
                </Link>
              </li>
              <li>
                <Link href="/dashboard" className="hover:text-orange-400 hover:translate-x-1 inline-flex items-center gap-2 transition-all duration-300">
                  <span className="w-1 h-1 rounded-full bg-slate-600"></span>
                  Track Application
                </Link>
              </li>
              ...
              <li>
                <Link href="/legal" className="hover:text-orange-400 hover:translate-x-1 inline-flex items-center gap-2 transition-all duration-300">
                  <span className="w-1 h-1 rounded-full bg-slate-600"></span>
      ...
      <div className="bg-black/40 border-t border-slate-900 py-4 text-[11px] text-slate-500">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 items-center">
            ...
            <div className="text-right">
              <div className="uppercase tracking-wider text-[9px] mb-0.5">Total Audits Filed</div>
