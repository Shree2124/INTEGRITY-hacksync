      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 cursor-pointer transition-colors">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-xs text-slate-400 truncate">Citizen Auditor</p>
          </div>
        </div>
      </div>
    </aside>
                  ...
                  {MY_REPORTS.map((report) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                        ...
                        <div
                          className={`px-3 py-1 rounded-full text-xs font-bold uppercase self-start md:self-center ${
                            report.risk === "High"
              ...
              >
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                  <div className="relative z-10">
                    ...
                    <button className="bg-white text-blue-700 px-5 py-2.5 rounded-lg text-sm font-bold shadow hover:bg-blue-50 transition-colors">
                      Start Generator
                    </button>
                  </div>
